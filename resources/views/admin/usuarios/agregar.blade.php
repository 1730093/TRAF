                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input name="apellido_mat" class="form-control input-sm" type="text"
                                placeholder="Ingresa el apellido materno del empleado">
                            @error('apellido_mat')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <select name="id_genero" class="form-select" aria-label="Default select example">
                            ...
                            <input name="email" class="form-control input-sm" type="email"
                                placeholder="Ingresa el correo electronico del empleado">
                            @error('email')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
